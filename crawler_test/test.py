...
driver = webdriver.Chrome(executable_path = '/Users/arthurlin/Downloads/chromedriver', options=options) 
...
def run():
    ...
    cnt = 0
    search('Software Engineer','United States')
    while cnt <= 10: # 5000 => 165, Finished in 1145.93 second(s)  = 20 min
        cnt += 1
        print(cnt)
        ...
        try:
            ...
            """
            <button 
            class="infinite-scroller__show-more-button 
...
#     back = cursor.executemany("INSERT INTO linkedinJob (position,company,location,status,posttime,savetodbtime,details) VALUES(%s,%s,%s,%s,%s,%s,%s)", data) 
#     connection.commit()
#     print(back)
# driver.quit()
